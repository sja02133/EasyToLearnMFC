...
CStaticDoc::CStaticDoc() noexcept
{
...
void CStaticDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CStaticDoc::InitializeSearchContent()
{
...
void CStaticDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
