...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	//2023.07.05 formview 사용 방법
	/*
	CCreateContext ccx;
	ccx.m_pNewViewClass = RUNTIME_CLASS(FormView_1);
	CWnd* pNewView = this->CreateView(&ccx);
	m_pMainView = DYNAMIC_DOWNCAST(FormView_1, pNewView);
...
void CMainFrame::OnSetFocus(CWnd* /*pOldWnd*/)
{
	...
	//formview 사용 시 이곳 SetFocus() 함수 부분 주석 처리해야함
	m_wndView.SetFocus();
}
