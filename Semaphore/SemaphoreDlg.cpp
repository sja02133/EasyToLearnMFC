...
// SemaphoreDlg.cpp : implementation file
//
...
// CSemaphoreDlg message handlers
...
CSemaphore g_sem(2, 2,_T("MySemaphore"));
...
void CSemaphoreDlg::OnBnClickedStart()
{
	...
	::WaitForSingleObject(g_sem.m_hObject, INFINITE);
...
BOOL CSemaphoreDlg::PreTranslateMessage(MSG* pMsg)
{
