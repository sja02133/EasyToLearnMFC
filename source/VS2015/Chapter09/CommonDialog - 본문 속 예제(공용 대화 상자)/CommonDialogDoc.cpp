...
// CommonDialogDoc.cpp: CCommonDialogDoc 클래스의 구현
//
...
// CCommonDialogDoc 생성/소멸

CCommonDialogDoc::CCommonDialogDoc() noexcept
{
...
// 축소판 그림을 지원합니다.
void CCommonDialogDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CCommonDialogDoc::InitializeSearchContent()
{
...
void CCommonDialogDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
