// CStudent.h : CStudent의 선언입니다.

#pragma once

// 코드 생성 위치 2020년 2월 7일 금요일, 오후 10:17

class CStudentAccessor
{
public:
	LONG m_ST_NUM;
	TCHAR m_ST_NAME[256];
...
// 다른 형식으로 암호를 저장하거나 다른 사용자 인증을 사용하십시오.
		hr = _db.OpenFromInitializationString(L"Provider=MSDASQL.1;Persist Security Info=False;Data Source=student;Extended Properties=\"DSN=student;DBQ=C:\\SOURCE\\VS2017\\CHAPTER14\\student.accdb;DriverId=25;FIL=MS Access;MaxBufferSize=2048;PageTimeout=5;\"");
		if (FAILED(hr))
		{
#ifdef _DEBUG
	...
	BEGIN_COLUMN_MAP(CStudentAccessor)
...
class CStudent : public CTable<CAccessor<CStudentAccessor> >
{
public:
	HRESULT OpenAll()
	{
