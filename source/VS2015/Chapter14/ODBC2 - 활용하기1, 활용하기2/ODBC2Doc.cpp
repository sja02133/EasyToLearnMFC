...
// ODBC2Doc.cpp : CODBC2Doc 클래스의 구현
//
...
// 축소판 그림을 지원합니다.
void CODBC2Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CODBC2Doc::InitializeSearchContent()
{
...
void CODBC2Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
