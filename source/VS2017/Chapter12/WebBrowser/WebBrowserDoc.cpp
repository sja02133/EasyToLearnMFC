...
// WebBrowserDoc.cpp: CWebBrowserDoc 클래스의 구현
//
...
// CWebBrowserDoc 생성/소멸

CWebBrowserDoc::CWebBrowserDoc() noexcept
{
...
// 축소판 그림을 지원합니다.
void CWebBrowserDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CWebBrowserDoc::InitializeSearchContent()
{
...
void CWebBrowserDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
